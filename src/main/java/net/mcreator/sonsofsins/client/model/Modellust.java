...
extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(32, 48).addBox(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new CubeDeformation(-0.2f)).texOffs(0, 0).addBox(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new CubeDeformation(0.275f)).texOffs(0, 16).addBox(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation((float)0.0f, (float)2.0f, (float)-2.9f, (float)-0.0436f, (float)0.0f, (float)0.0f));
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 32).addBox(-1.5f, 0.0f, -1.5f, 3.0f, 12.0f, 3.0f, new CubeDeformation(-0.175f)).texOffs(12, 32).addBox(-1.5f, 0.0f, -1.5f, 3.0f, 12.0f, 3.0f, new CubeDeformation(0.025f)).texOffs(32, 6).addBox(-4.5f, 2.0f, -1.5f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.3f)).texOffs(24, 0).addBox(-4.5f, 2.0f, -1.5f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.1f)).texOffs(32, 6).addBox(-4.5f, 5.25f, -1.5f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.4f)).texOffs(24, 0).addBox(-4.5f, 5.25f, -1.5f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.2f)).texOffs(24, 0).addBox(-4.5f, 8.25f, -1.7f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.3f)).texOffs(32, 6).addBox(-4.5f, 8.25f, -1.7f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.5f)), PartPose.offsetAndRotation((float)0.0f, (float)1.75f, (float)-2.25f, (float)0.1309f, (float)0.0f, (float)0.0f));
        PartDefinition bone2 = body.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 32).addBox(-1.5f, 0.0f, -1.5f, 3.0f, 7.0f, 3.0f, new CubeDeformation(-0.175f)).texOffs(12, 32).addBox(-1.5f, 0.0f, -1.5f, 3.0f, 7.0f, 3.0f, new CubeDeformation(0.025f)), PartPose.offsetAndRotation((float)0.0f, (float)11.25f, (float)-0.2f, (float)0.48f, (float)0.0f, (float)0.0f));
        PartDefinition head_isTarget = partdefinition.addOrReplaceChild("head_isTarget", CubeListBuilder.create().texOffs(96, 112).addBox(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new CubeDeformation(-0.2f)).texOffs(64, 64).addBox(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new CubeDeformation(0.275f)).texOffs(64, 80).addBox(-4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f, new CubeDeformation(0.0f)), PartPose.offset((float)0.0f, (float)4.0f, (float)-4.9f));
        PartDefinition body_isTarget = partdefinition.addOrReplaceChild("body_isTarget", CubeListBuilder.create().texOffs(64, 96).addBox(-1.5f, -6.5f, -1.45f, 3.0f, 12.0f, 3.0f, new CubeDeformation(-0.175f)).texOffs(76, 96).addBox(-1.5f, -6.5f, -1.45f, 3.0f, 12.0f, 3.0f, new CubeDeformation(0.025f)).texOffs(96, 70).addBox(-4.5f, -4.5f, -1.45f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.3f)).texOffs(88, 64).addBox(-4.5f, -4.5f, -1.45f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.1f)).texOffs(96, 70).addBox(-4.5f, -1.25f, -1.45f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.4f)).texOffs(88, 64).addBox(-4.5f, -1.25f, -1.45f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.2f)).texOffs(88, 64).addBox(-4.5f, 1.75f, -1.65f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.3f)).texOffs(96, 70).addBox(-4.5f, 1.75f, -1.65f, 9.0f, 3.0f, 3.0f, new CubeDeformation(-0.5f)), PartPose.offsetAndRotation((float)0.0f, (float)8.1032f, (float)-1.5627f, (float)0.6109f, (float)0.0f, (float)0.0f));
        PartDefinition bone3 = body_isTarget.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(64, 96).addBox(-1.5f, 0.0f, -1.5f, 3.0f, 7.0f, 3.0f, new CubeDeformation(-0.175f)).texOffs(76, 96).addBox(-1.5f, 0.0f, -1.5f, 3.0f, 7.0f, 3.0f, new CubeDeformation(0.025f)), PartPose.offsetAndRotation((float)0.0f, (float)4.75f, (float)-0.15f, (float)0.48f, (float)0.0f, (float)0.0f));
