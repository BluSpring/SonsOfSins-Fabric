...
extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0f, -12.0f, -4.0f, 12.0f, 12.0f, 8.0f, new CubeDeformation(0.0f)).texOffs(32, 0).addBox(-4.0f, -7.0f, 4.0f, 8.0f, 5.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(28, 26).addBox(-5.0f, -22.0f, -2.0f, 4.0f, 10.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(28, 25).mirror().addBox(1.0f, -27.0f, -2.0f, 4.0f, 16.0f, 4.0f, new CubeDeformation(0.0f)).mirror(false).texOffs(0, 20).addBox(-5.5f, -15.0f, -2.5f, 11.0f, 4.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(0, 29).mirror().addBox(0.5f, -29.0f, -2.5f, 5.0f, 3.0f, 5.0f, new CubeDeformation(0.0f)).mirror(false).texOffs(0, 29).addBox(-5.5f, -25.0f, -2.5f, 5.0f, 3.0f, 5.0f, new CubeDeformation(0.0f)), PartPose.offset((float)0.0f, (float)24.0f, (float)0.0f));
